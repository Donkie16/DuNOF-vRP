  ...
  RegisterCommand('frp', function(source, args, user)
  	TriggerClientEvent('chatMessage', -1, "FORA DO RP | " .. GetPlayerName(source), {128, 128, 128}, table.concat(args, " "))
  end, false)

  RegisterCommand('ilegal', function(source, args, user)
    TriggerClientEvent('chatMessage', -1, "^0[^4ILEGAL^0] ", {128, 128, 128}, table.concat(args, " "))
  end, false)
